 ...
 */
 ...
 function changeBackgroundColor(color) {
   ...
   chrome.tabs.captureVisibleTab(null, {}, function (image) {
      ...
      // Get the capture into the canvas
      // script += 'img_element = document.getElementById("screenshot_target");'
      // script += 'img_element.src = "'+image+'";';
      // script += 'img_element.height = 0;';

      // // script += 'larger_canvas = document.getElementById("screenshot_canvas");'
      // // script += 'larger_canvas.opacity = 0;';
      ...
      //   script += 'rect = document.getEledmentById("iframe").getBoundingClientRect();';
